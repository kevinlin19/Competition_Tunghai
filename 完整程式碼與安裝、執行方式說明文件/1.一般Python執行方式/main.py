...
# load model
def load_predict_xgb_model(model_path="./model_save/xgboost.pickle.dat", X_jacky_input=None, file_name=None):
...
if __name__ == '__main__':
    ...
    load_predict_xgb_model(X_jacky_input=input_data, file_name=file_name)